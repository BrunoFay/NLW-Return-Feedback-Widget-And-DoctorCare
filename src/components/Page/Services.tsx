...
export default function Services() {
  ...
  return (
    <section
      id='services'
      className="w-[23.438rem] md:w-[80%]  md:self-center md:h-[57.625rem]
     h-[127.125rem] text-center flex flex-col " >
      <section className="mt-[7.875rem] h-[9.625rem] md:items-center w-[19.625rem] mx-auto gap-4 flex flex-col">
        <h4 className="text-brandColor-500 font-bold text-base">SERVIÇOS</h4>
        <h2 className="font-bold text-3xl w-[19.625rem] md:w-[23rem] h-[7.313rem] text-[#212529] ">Como podemos ajudá-lo a se sentir melhor?
        </h2>
      </section>
      <section
        ref={ref}
